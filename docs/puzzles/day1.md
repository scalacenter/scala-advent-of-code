...
- [Solution](https://github.com/philipschwarz/advent-of-code-2021-scala/blob/master/src/main/scala/DayOne.scala) by [@philip_schwarz](https://twitter.com/philip_schwarz) with and without Cats
